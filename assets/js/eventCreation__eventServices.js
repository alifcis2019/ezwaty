...
eventCreation__eventServices__serviceSelected__box[0].style.display = "block";
for (
  let i = 0;
...
let eventServices__checkout = document.querySelector(".eventServices__checkout")
let checkOut__menu__close = document.querySelector(".checkOut__menu__close")
let eventServices__checkout__open = false
eventServices__checkout.addEventListener('click',()=>{
    if(!eventServices__checkout__open) {
        document.querySelector(".checkOut__container").style.display="block"
        eventServices__checkout__open=true
        // document.querySelector(".checkOut__container").style.opacity = ""
        document.querySelector(".checkOut__container").style.backgroundColor = "gray;"
    }
})

checkOut__menu__close.addEventListener('click',()=>{
  document.querySelector(".checkOut__container").style.display="none"
  eventServices__checkout__open=false
})
